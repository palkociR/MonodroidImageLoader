...
namespace Com.Nostra13.Universalimageloader.Cache.Disc.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='TotalSizeLimitedDiscCache']"
	[global::Android.Runtime.Register ("com/nostra13/universalimageloader/cache/disc/impl/TotalSizeLimitedDiscCache", DoNotGenerateAcw=true)]
	public partial class TotalSizeLimitedDiscCache : global::Com.Nostra13.Universalimageloader.Cache.Disc.LimitedDiscCache {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/nostra13/universalimageloader/cache/disc/impl/TotalSizeLimitedDiscCache", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (TotalSizeLimitedDiscCache); }
		}

		protected TotalSizeLimitedDiscCache (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_io_File_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='TotalSizeLimitedDiscCache']/constructor[@name='TotalSizeLimitedDiscCache' and count(parameter)=2 and parameter[1][@type='java.io.File'] and parameter[2][@type='int']]"
		[Register (".ctor", "(Ljava/io/File;I)V", "")]
		public TotalSizeLimitedDiscCache (global::Java.IO.File p0, int p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (TotalSizeLimitedDiscCache)) {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='TotalSizeLimitedDiscCache']/constructor[@name='TotalSizeLimitedDiscCache' and count(parameter)=3 and parameter[1][@type='java.io.File'] and parameter[2][@type='com.nostra13.universalimageloader.cache.disc.naming.FileNameGenerator'] and parameter[3][@type='int']]"
		[Register (".ctor", "(Ljava/io/File;Lcom/nostra13/universalimageloader/cache/disc/naming/FileNameGenerator;I)V", "")]
		public TotalSizeLimitedDiscCache (global::Java.IO.File p0, global::Com.Nostra13.Universalimageloader.Cache.Disc.Naming.IFileNameGenerator p1, int p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Nostra13.Universalimageloader.Cache.Disc.Impl.TotalSizeLimitedDiscCache __this = global::Java.Lang.Object.GetObject<global::Com.Nostra13.Universalimageloader.Cache.Disc.Impl.TotalSizeLimitedDiscCache> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='TotalSizeLimitedDiscCache']/method[@name='getSize' and count(parameter)=1 and parameter[1][@type='java.io.File']]"

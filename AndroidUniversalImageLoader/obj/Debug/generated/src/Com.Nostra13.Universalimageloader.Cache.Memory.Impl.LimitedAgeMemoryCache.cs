...
namespace Com.Nostra13.Universalimageloader.Cache.Memory.Impl {
	...
	public partial class LimitedAgeMemoryCache : global::Java.Lang.Object, global::Com.Nostra13.Universalimageloader.Cache.Memory.IMemoryCacheAware {
		...
		static IntPtr id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCacheAware_J;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/constructor[@name='LimitedAgeMemoryCache' and count(parameter)=2 and parameter[1][@type='com.nostra13.universalimageloader.cache.memory.MemoryCacheAware'] and parameter[2][@type='long']]"
		[Register (".ctor", "(Lcom/nostra13/universalimageloader/cache/memory/MemoryCacheAware;J)V", "")]
		public LimitedAgeMemoryCache (global::Com.Nostra13.Universalimageloader.Cache.Memory.IMemoryCacheAware p0, long p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (LimitedAgeMemoryCache)) {
				SetHandle (global::Android.Runtime.JNIEnv.CreateInstance (GetType (), "(Lcom/nostra13/universalimageloader/cache/memory/MemoryCacheAware;J)V", new JValue (p0), new JValue (p1)), JniHandleOwnership.TransferLocalRef);
				return;
			}

			if (id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCacheAware_J == IntPtr.Zero)
				id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCacheAware_J = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/nostra13/universalimageloader/cache/memory/MemoryCacheAware;J)V");
			SetHandle (JNIEnv.NewObject (class_ref, id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCacheAware_J, new JValue (p0), new JValue (p1)), JniHandleOwnership.TransferLocalRef);
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/method[@name='get' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/method[@name='put' and count(parameter)=2 and parameter[1][@type='java.lang.Object'] and parameter[2][@type='java.lang.Object']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/method[@name='remove' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
